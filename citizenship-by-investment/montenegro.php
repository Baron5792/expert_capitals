...
<head>
		<title> Montenegro | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">Montenegro</h2>
            </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <h4><strong style="color: #ea6f43; letter-spacing: 1.5px; font-weight: 500;">From €350,000</strong></h4>
        <br>
        <p><strong style="color: #ea6f43;">123 Countries & Territories</strong></p>
        <p>
        ...
        <p>Discover a world of benefits within Montenegro:</p>

        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>Fast procedure. Residency within 3 weeks and approval of citizenship within six months.</li>
            <li>Dependents under 18 years of age are also granted citizenship with main applicants.</li><li>No language requirements.</li>
            <li>No obligation to relinquish current nationality.</li>
            <li>NATO Member.</li>
            <li>Candidate country for future expansion of the EU, expected by 2025.</li><li>Global mobility with access to 124nations visa-free.</li>
            <li>Strategic geographical location in Europe with direct access to Adriatic Sea.</li>
            <li>Porto Montenegro; one of the world’s finest yachting marinas.</li>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            ...
            <li>Possess a valid passport or another foreign travel document.</li>
            <li>Provide documents supporting the source and origin of invested funds.</li>
            <li>Hold no criminal record.</li>
            <li>Attest the power of attorneys and the investment agreement.</li>
        </ul>
        ...
        <ol style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            ...
            <p>Applicants must make a contribution of €100,000 in the form of a government fund donation</p>
            ...
            <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
                ...
                <li>€250,000 investment in an undeveloped region (north of the country), or</li>
                <li>€450,000 investment in a developed region (south of the country).</li>
        ...
        <form method="post" action="https://efinancebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="Montenegro">
