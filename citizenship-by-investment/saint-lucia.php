...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
		<title> Saint Lucia | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">Saint Lucia</h2>
            </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <br>
        <p><strong style="color: #ea6f43;">146 Countries & Territories</strong></p>
        <p>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            ...
            <li>No requirement to travel to Saint Lucia during the application process.</li>
            <li>No interview, education or managerial experience required.</li>
            <li>Visa-free travel to more than 100 countries, including the Schengen Zone, the U.K. and Hong Kong.</li>
        ...
        <form method="post" action="https://e-financebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="Saint Lucia">
