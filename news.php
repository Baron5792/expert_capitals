...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
		<title> News | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('assets/templates/bank/frontend/images/bg/news.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <p class="breadcrumbs"><a href="index.php" rel="v:url"><i class="twi-home-alt1"></i>Home</a><span>/</span>News</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container largeContainer">
        <div class="row">
                    ...
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2023/03/30/642486393e2ff1680115257.png" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>30 Mar, 2023 </a></span> 
                                
                            </div>
                            <h3><a href="news/e-finance-management-bank-makes-donation-to-turkey-earthquake-relief.php">E - finance management bank Makes Donation to Turkey Earthquake Relief</a></h3>
                            <a class="rm_more" href="news/e-finance-management-bank-makes-donation-to-turkey-earthquake-relief.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2023/03/18/64151d45c88d71679105349.png" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>07 Mar, 2023 </a></span> 
                            ...
                            <a class="rm_more" href="news/the-importance-of-emergency-funds-how-to-build-and-maintain-one.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2023/03/18/64151d74eee381679105396.png" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                            ...
                            <h3><a href="news/8-financial-planning-tips-for-a-successful-2023.php">8 Financial Planning Tips for a Successful 2023</a></h3>
                            <a class="rm_more" href="news/8-financial-planning-tips-for-a-successful-2023.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2023/02/21/63f3ffd22f4911676935122.jpg" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>21 Feb, 2023 </a></span> 
                                
                            </div>
                            <h3><a href="news/staking-vs-investing-in-cryptocurrency-understanding-the-key-differences.php">Staking vs Investing in Cryptocurrency: Understanding the Key Differences</a></h3>
                            <a class="rm_more" href="news/staking-vs-investing-in-cryptocurrency-understanding-the-key-differences.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2022/07/28/62e273118814e1659007761.jpg" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>28 Jul, 2022 </a></span> 
                                
                            </div>
                            <h3><a href="news/unveiling-our-new-operations-branch-office.php">Unveiling our New Operations Branch Office</a></h3>
                            <a class="rm_more" href="news/unveiling-our-new-operations-branch-office.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2022/06/22/62b25e6e676581655856750.jpg" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>21 Apr, 2022 </a></span> 
                                
                            </div>
                            <h3><a href="news/efinancebank-extends-fast-banking-services-to-dubai.php">EfinanceBank Extends Fast Banking Services to Dubai</a></h3>
                            <a class="rm_more" href="news/efinancebank-extends-fast-banking-services-to-dubai.php">Read More</a>
                        </div>
                    </div>
                </div>
                            <div class="col-lg-4 col-md-6">
                    <div class="blogItem03 bbrm">
                        <div class="blogThumb">
                            <img src="assets/images/news/2022/06/17/62abd44f5c2141655428175.jpg" alt="">
                        </div>
                        <div class="blogContent">
                            <div class="bmeta">
                                <span><i class="twi-user2"></i><a>Admin</a></span> 
                                | <span><i class="twi-calendar-alt1"></i><a>29 Jan, 2017 </a></span> 
                                
                            </div>
                            <h3><a href="news/efinance-bank-partners-with-alvin-insurance-to-provide-collateralized-loan-support-to-users.php">Efinance Bank partners with Alvin Insurance to provide collateralized loan support to users</a></h3>
                            <a class="rm_more" href="news/efinance-bank-partners-with-alvin-insurance-to-provide-collateralized-loan-support-to-users.php">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="aboutWidget" style="text-align: center">
                            ...
                            <img src="assets/images/logoIcon/f-logo2.png" alt="E-Finance" style="display: block; margin: 0 auto;" width="200px">
                    ...
                    <div class="col-md-6 col-lg-2">
                        <div class="widget PL28">
                            <h3 class="widget_title">The Experts</h3>
                            <ul class="menu">
                                <li><a href="who-we-are.php">About Us</a></li>
