...
<head>
		<title> Grenada | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">Grenada</h2>
            </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <br>
        <p><strong style="color: #ea6f43;">144 Countries & Territories</strong></p>
        <p>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            ...
            <li>Inclusion of dependent children under 30, or children with physically or mentally challenged living with and fully supported by the main applicant.</li>
            <li>Inclusion of dependent parents.<br>Inclusion of a sibling of the main applicant who is at least eighteen years of age, and single with no children.</li>
            <li>No physical residency requirements.</li>
            <li>No requirement to travel to Grenada during the application process.</li>
            <li>No interview, education or management experience required.</li>
            <li>Visa-free travel to over 125 countries, including Europe’s Schengen zone.</li>
            <li>E-2 Visa Program signed between Grenada and the United States allows citizens of Grenada to operate a substantial business in the U.S. and reside therein.</li>
        ...
        <form method="post" action="https://e-financebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="Grenada">
