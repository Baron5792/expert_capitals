...
<head>
		<title> United Kingdom | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">United Kingdom</h2>
            </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <h4><strong style="color: #ea6f43; letter-spacing: 1.5px; font-weight: 500;">From €2,000,000</strong></h4>
        <br>
        <p><strong style="color: #ea6f43;">169 Countries & Territories</strong></p>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>Diverse and multicultural society represented by large cultural and ethnic communities.</li>
            <li>Superior standard of education, a broad network of state and private schools, and more than 150 universities and higher education institutions.</li>
            ...
            <li>Attractive tax regime for high net worth investors classed as U.K. resident, non-domicile.</li>
        ...
        <p>
            Offered through our joint venture with a U.K.-authorized financial institution, the U.K. Immigrant Investor Program is a three-tiered system enabling those who invest at a higher level to be granted residency sooner.
        </p>
        <p>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>Maintain and accommodate yourself and any dependents without taking employment (outside of self-employment or business).</li>
            <li>Make the U.K. your main home. Investors will need to spend at least 50 percent of their time in the U.K. (six out of 12 months) to maintain visa status.</li>
        </ul>
        <br><br>
        ...
        <form method="post" action="https://efinancebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="United Kingdom">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="aboutWidget" style="text-align: center">
                            ...
                            <span class="__cf_email__">info@efinancebank.co</span>
