...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
		<title> Malta | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">Malta</h2>
            </div>
            <div class="col-md-4 text-right">
                <p class="breadcrumbs">
                    ...
                    <span>/</span>
                    MALTESE EXCEPTIONAL INVESTMENT NATURALIZATION (MEIN)
                </p>
            </div>
        </div>
    </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <h4><strong style="color: #ea6f43; letter-spacing: 1.5px; font-weight: 500;">From €600,000</strong></h4>
        <br>
        <p><strong style="color: #ea6f43;">184 Countries Visa-free</strong></p>
        <p>
            The Maltese Exceptional Investment Naturalization (MEIN) allows for the granting of citizenship for exceptional services to individuals and their families who make a direct investment in the Republic of Malta, contributing to the social and economic development of the country.
        </p>
        <br><br>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>Malta is a Mediterranean island with a significant historical and cultural legacy spanning over 7,000 years.</li>
            <li>A member of the Commonwealth.</li>
            <li>Malta is a full EU Member State.</li>
            <li>One of the most exceptional places to do business.</li>
            <li>Malta has one of the fastest-growing economies and the top GDP growth rates in the EU, offering favorable legislation.</li>
            <li>A stable and safe European country with a strong economy.</li>
            <li>Malta is good for investment, tax optimization, and immigration into Europe, its low taxation opportunities, the government’s investment incentives, and finally the country’s safety and excellent lifestyle.</li>
        </ul>
        <br><br>

        
        <h4><strong style="color: #ea6f43; letter-spacing: 1.5px; font-weight: 500;">PRIVILEGES </strong></h4>
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>Visa-free travel to 184 countries.</li>
            <li>Procedure takes three years or by exception one year through higher investment: The main applicant and all adult dependants must have been a legal resident of Malta for three years or by exception at least one year, demonstrating connecting factors to Malta during the residence period, prior to being naturalized.</li>
            <li>Malta is the only English-speaking country in the Schengen Area.</li>
            <li>Opportunity to open new businesses</li>
            <li>Opportunity to open bank accounts</li>
            <li>Access to better &amp; quality education for your children</li>
            <li>The right to reside in Malta</li>
            <li>Family members including children, parents, and grandparents of the main applicant and spouse can be added.</li>
            <li>Free education for all students in state schools which includes free transportation and books</li><li>A bilingual country</li>
            <li>Zero Taxation on Worldwide Income</li>
        </ul>

        <p><strong style="color: #ea6f43;">Requirements to qualify for citizenship</strong></p>
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            <li>The main applicant must be over 18 years of age</li>
            <li>Be of outstanding character</li>
            <li>Have no criminal record</li>
            <li>Be in good health, and</li>
            <li>Pass strict government due diligence checks.</li>
            <li>Make a direct investment, contributing to the National Development and Social Fund;</li>
        </ul>
        ...
        <form method="post" action="https://e-financebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="Malta">
