                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title text-center"> - <span class="base--color">Enter a New Password</span> </h4>
                                ...
                                <form action="<?= URL ?>password/verify-logic.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg " id="password" name="password" value="" required autofocus="off" placeholder="Enter your New Password" required>
                                            <input type="text" class="form-control form-control-lg mt-2" id="password" name="confirm_password" value="" required autofocus="off" placeholder="Confirm your New Password" required>
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <button type="submit" class="btn btn-lg btn-dark btn-block" name="verify">Submit</button>
                                    </div>
                                </form>
