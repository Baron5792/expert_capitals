...
<head>
		<title> Portugal | Expert Capital </title>
...
<section class="page_banner" style="background-image: url('<?= URL ?>assets/templates/bank/frontend/images/bg/citizenship.png'); height: 100px;">
    <div class="container largeContainer">
        <div class="row">
            <div class="col-md-8">
                <h2 class="banner-title">Portugal</h2>
            </div>
...
<section class="aboutSection04" style="padding: 120px 0 120px;">
    <div class="container">
        ...
        <br>
        <p><strong style="color: #ea6f43;">186 Countries & Territories</strong></p>
        <p>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px;   font-size: 15px">
            ...
            <li>Live and work in Portugal.</li>
            <li>Visa-free travel within the Schengen member states.</li>
            <li>Permanent residency or citizenship of Portugal after five years as a temporary resident.</li>
            <li>Inclusion of family members, such as spouse or partner, dependent children and dependent parents.</li>
        </ul>
        <br><br>
        ...
        <ul style="line-height: 1.7; margin-bottom: 15px; font-size: 15px">
            <li>Provide proof that investment funds originate from abroad.</li>
            <li>Hold no criminal record.</li>
            <li>The main applicant’s property is not frozen within the boundaries of the EU.</li>
            <li>Pay application and processing fees where applicable.</li>
            <li>Enter Portugal for the first time on a valid Schengen visa.</li>
            <li>Meet or exceed the minimum stay requirements. (Seven days for the first year, 14 days for subsequent two-year periods.)</li>
        </ul>
        <br><br>
        ...
        <form method="post" action="https://e-financebank.co/citizenship-by-investment/apply" enctype="multipart/form-data">
            ...
            <input type="hidden" name="citizenship" value="Portugal">
